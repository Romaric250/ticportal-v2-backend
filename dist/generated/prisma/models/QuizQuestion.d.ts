...
export type QuizQuestionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "quizId" | "question" | "options" | "correctAnswer" | "points", ExtArgs["result"]["quizQuestion"]>;
...
export interface QuizQuestionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more QuizQuestions that matches the filter.
     * @param {QuizQuestionFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const quizQuestion = await prisma.quizQuestion.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: Prisma.QuizQuestionFindRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>;
    /**
     * Perform aggregation operations on a QuizQuestion.
     * @param {QuizQuestionAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const quizQuestion = await prisma.quizQuestion.aggregateRaw({
     *   pipeline: [
     ...
     * })
     */
    aggregateRaw(args?: Prisma.QuizQuestionAggregateRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>;
    /**
...
/**
 * QuizQuestion findRaw
 */
export type QuizQuestionFindRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
    /**
...
/**
 * QuizQuestion aggregateRaw
 */
export type QuizQuestionAggregateRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
    /**

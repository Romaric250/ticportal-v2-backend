...
router.post("/deliverables/:deliverableId/upload-and-submit", upload.single("file"), DeliverableFileController.uploadAndSubmit);
// Admin: Upload file for team
router.post("/admin/deliverables/:teamId/upload-and-submit", upload.single("file"), DeliverableFileController.adminUploadAndSubmit);

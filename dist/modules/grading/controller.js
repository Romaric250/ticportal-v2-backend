...
export class GradingController {
    static async getRubric(_req, res) {
        try {
    ...
    static async postRubric(req, res) {
        try {
    ...
    static async setReviewer(req, res) {
        try {
    ...
    static async listReviewers(_req, res) {
        try {
    ...
    static async reviewerWorkload(_req, res) {
        try {
    ...
    static async pendingGrades(_req, res) {
        try {
    ...
    static async manualAssign(req, res) {
        try {
            const { assignments, sendMail } = req.body;
    ...
    static async unassignReviewer(req, res) {
        try {
            const { teamId, reviewerId, replacementReviewerId, sendMail } = (req.body || {});
    ...
    static async assignmentsForTeam(req, res) {
        try {
    ...
    static async listAssignments(_req, res) {
        try {
    ...
    static async submitGrade(req, res) {
        try {
            const { teamId } = req.params;
            if (!teamId) {
                return res.status(400).json({ success: false, message: "teamId required" });
    ...
    static async getTeamReviews(req, res) {
        try {
            const { teamId } = req.params;
            if (!teamId) {
                return res.status(400).json({ success: false, message: "teamId required" });
    ...
    static async leaderboardConfigGet(_req, res) {
        try {
    ...
    static async leaderboardConfigPost(req, res) {
        try {
            const { leaderboardScorePercent, leaderboardPointsMax, maxTeamsPerReviewer } = req.body;
            if (leaderboardScorePercent == null &&
            ...
            const data = await GradingService.setLeaderboardConfig({
                ...
                ...(maxTeamsPerReviewer !== undefined && {
                    maxTeamsPerReviewer: maxTeamsPerReviewer === null ? null : Number(maxTeamsPerReviewer),
                }),
            });
            return res.json({ success: true, data });
        }
    ...
    static async finalizeBulk(req, res) {
        try {
    ...
    static async leaderboardApply(req, res) {
        try {
    ...
    static async reviewerDashboard(req, res) {
        try {
            const id = requireUid(req, res);
            if (!id)
                return;
    ...
    static async gradingReportTeamDetail(req, res) {
        try {
            const { teamId } = req.params;
            if (!teamId) {
                return res.status(400).json({ success: false, message: "teamId required" });

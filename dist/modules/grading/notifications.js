...
export async function notifyReviewerStatusGranted(email, firstName, granted) {
    ...
    <p>${granted
        ...
        : "Your reviewer access has been revoked. Contact an administrator if this is unexpected."}</p>
...
export async function notifyTeamAssignment(email, firstName, teamName, teamId) {
...
export async function notifyPeerReviewSubmitted(email, firstName, teamName, otherReviewerName) {
...
export async function notifyGradeFinalized(email, firstName, teamName, finalScore) {

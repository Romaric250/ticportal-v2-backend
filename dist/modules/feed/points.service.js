...
export class FeedPointsService {
     ...
     */
    static async awardPostCreationPoints(userId, postId, hasImages, hasVideo) {
        try {
            let totalPoints = FEED_POINTS.CREATE_POST;
            const reasons = ["Created a post"];
     ...
     */
    static async awardLikeReceivedPoints(postAuthorId, postId, likerId) {
        try {
     ...
     */
    static async awardLikeGivenPoints(userId, postId) {
        try {
     ...
     */
    static async awardCommentReceivedPoints(postAuthorId, postId, commenterId) {
        try {
     ...
     */
    static async awardCommentGivenPoints(userId, postId, commentId) {
        try {
     ...
     */
    static async awardBookmarkReceivedPoints(postAuthorId, postId, bookmarkerId) {
        try {
     ...
     */
    static async checkPostMilestones(postId, authorId) {
        try {
     ...
     */
    static async trackPostView(userId, postId, duration) {
        try {
            await activityService.trackActivity({
                userId,
     ...
     */
    static async awardViewPoints(userId, postId, postAuthorId, isFirstView) {
        try {
     ...
     */
    static async getUserFeedPointsSummary(userId) {
        try {

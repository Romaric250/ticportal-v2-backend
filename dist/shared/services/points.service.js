...
export class PointsService {
     ...
     */
    static async checkCooldown(params) {
     ...
     */
    static async getTodayPoints(userId, action) {
     ...
     */
    static async getUserActivityHistory(userId, activityType, limit = 50) {
     ...
     */
    static async awardEmailVerification(userId) {
        return this.awardPoints({
            userId,
            activityType: "AUTH",
     ...
     */
    static async awardStageCompletion(userId, stageId, stageName) {
        return this.awardPoints({
            userId,
     ...
     */
    static async awardQuizCompletion(userId, quizId, score, maxScore) {
     ...
     */
    static async awardBadgeEarned(userId, badgeId, badgeName) {
        return this.awardPoints({
            userId,
     ...
     */
    static async awardHackathonSubmission(userId, hackathonId, isOnTime) {

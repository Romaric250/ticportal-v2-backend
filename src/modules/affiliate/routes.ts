...
router.post(
  ...
  affiliateController.createCountry
);

router.get(
  '/admin/countries',
  authenticate,
  authorize([UserRole.ADMIN, UserRole.NATIONAL_COORDINATOR]),
  affiliateController.getCountries
);
...
router.put(
  ...
  authenticate,
  authorize([UserRole.ADMIN]),
  affiliateController.updateCountry
);
...
router.delete(
  ...
  authenticate,
  authorize([UserRole.ADMIN]),
  affiliateController.deleteCountry
);
...
router.post(
  ...
  authenticate,
  authorize([UserRole.ADMIN, UserRole.NATIONAL_COORDINATOR]),
  affiliateController.createRegion
);
...
router.put(
  ...
  authenticate,
  authorize([UserRole.ADMIN, UserRole.NATIONAL_COORDINATOR]),
  affiliateController.updateRegion
);
...
router.delete(
  ...
  authenticate,
  authorize([UserRole.ADMIN, UserRole.NATIONAL_COORDINATOR]),
  affiliateController.deleteRegion
);

router.get(
  '/admin/countries/:countryId/regions',
  authenticate,
  authorize([UserRole.ADMIN, UserRole.NATIONAL_COORDINATOR, UserRole.REGIONAL_COORDINATOR]),
  affiliateController.getRegionsByCountry
);
...
router.put(
  ...
  authenticate,
  authorize([UserRole.ADMIN]),
  affiliateController.updateUserRole
);

router.post(
  '/admin/affiliates',
  authenticate,
  authorize([UserRole.ADMIN, UserRole.AFFILIATE]),
  affiliateController.createAffiliateProfile
);

router.patch(
  '/admin/affiliates/:affiliateId/activate',
  authenticate,
  authorize([UserRole.ADMIN, UserRole.NATIONAL_COORDINATOR,UserRole.AFFILIATE ]),
  affiliateController.activateAffiliate
);
...
router.get(
  '/profile',
  authenticate,
  authorize([UserRole.AFFILIATE, UserRole.REGIONAL_COORDINATOR, UserRole.NATIONAL_COORDINATOR]),
...
router.get(
  ...
  authenticate,
  authorize([UserRole.AFFILIATE, UserRole.REGIONAL_COORDINATOR, UserRole.NATIONAL_COORDINATOR]),
  affiliateController.getMyReferrals
);
...
router.post(
  ...
  authenticate,
  authorize([UserRole.AFFILIATE, UserRole.REGIONAL_COORDINATOR, UserRole.NATIONAL_COORDINATOR]),
  affiliateController.regenerateReferralCode
);
...
router.get(
  '/regional/dashboard',
  authenticate,
  authorize([UserRole.REGIONAL_COORDINATOR, UserRole.NATIONAL_COORDINATOR, UserRole.ADMIN]),
  affiliateController.getRegionalDashboard
);
...
router.get(
  '/national/dashboard',
  authenticate,
  authorize([UserRole.NATIONAL_COORDINATOR, UserRole.ADMIN]),
  affiliateController.getNationalDashboard
);
